        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link href="/videos">
                  <a className="text-gray-300 hover:text-white transition-colors duration-200">Videos</a>
                </Link>
              </li>
              <li>
                <Link href="/downloads">
                  <a className="text-gray-300 hover:text-white transition-colors duration-200">Downloads</a>
                </Link>
              </li>
              <li>
